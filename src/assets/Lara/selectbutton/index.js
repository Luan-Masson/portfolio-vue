export default {
    ...
    button: ({ context }) => ({
        class: [
            ...
            // Color
            {
                'bg-slate-200 dark:bg-slate-900': !context.active,
                'text-surface-700 dark:text-white/80': !context.active,
                'border-surface-200 dark:border-surface-700': !context.active,
                'bg-primary-500 dark:bg-primary-800 border-primary-500 dark:border-primary-800 text-white dark:text-surface-900': context.active
            },

            // States
            'focus:outline-none focus:outline-offset-0 focus:z-10',
            {
                'hover:bg-surface-300/55 dark:hover:bg-slate-700/80': !context.active,
                'hover:bg-primary-600 dark:hover:bg-primary-700': context.active
            },
